...
set name case_1_mul_3s_3s_6_1_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename in_data_12 \
    op interface \
    ports { in_data_12_address0 { O 5 vector } in_data_12_ce0 { O 1 bit } in_data_12_q0 { I 3 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename in_data_14 \
    op interface \
    ports { in_data_14_address0 { O 5 vector } in_data_14_ce0 { O 1 bit } in_data_14_q0 { I 3 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_conv25_i3788 \
    op interface \
    ports { conv25_i3788 { I 11 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_m18_18_out \
    op interface \
    ports { m18_18_out_i { I 32 vector } m18_18_out_o { O 32 vector } m18_18_out_o_ap_vld { O 1 bit } } \
} "
}
...
set InstName case_1_flow_control_loop_pipe_sequential_init_U
set CompName case_1_flow_control_loop_pipe_sequential_init
