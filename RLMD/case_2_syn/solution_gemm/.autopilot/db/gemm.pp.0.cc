...
void gemm( double m1[64*64], double m2[64*64], double prod[64*64] ){
    ...
    outer_1:for(i_1=0; i_1<64; i_1++) {
        middle_1:for(j_1=0; j_1<64; j_1++) {
            i_col_1 = i_1 * 64;
            double sum_1 = 0;
            inner_1:for(k_1=0; k_1<64; k_1++) {
                k_col_1 = k_1 * 64;
                mult_1 = m1[i_col_1 + k_1] * m2[k_col_1 + j_1];
                sum_1 += mult_1;
            }
            prod[i_col_1 + j_1] = sum_1;
        }
    }
    ...
    outer_2:for(i_2=0; i_2<64; i_2++) {
        middle_2:for(j_2=0; j_2<64; j_2++) {
            i_col_2 = i_2 * 64;
            double sum_2 = 0;
            inner_2:for(k_2=0; k_2<64; k_2++) {
                k_col_2 = k_2 * 64;
                mult_2 = m1[i_col_2 + k_2] * m2[k_col_2 + j_2];
                sum_2 += mult_2;
            }
            prod[i_col_2 + j_2] = sum_2;
        }
    }
    ...
    outer_3:for(i_3=0; i_3<64; i_3++) {
        middle_3:for(j_3=0; j_3<64; j_3++) {
            i_col_3 = i_3 * 64;
            double sum_3 = 0;
            inner_3:for(k_3=0; k_3<64; k_3++) {
                k_col_3 = k_3 * 64;
                mult_3 = m1[i_col_3 + k_3] * m2[k_col_3 + j_3];
                sum_3 += mult_3;
            }
            prod[i_col_3 + j_3] = sum_3;
        }
    }
    ...
    outer_4:for(i_4=0; i_4<64; i_4++) {
        middle_4:for(j_4=0; j_4<64; j_4++) {
            i_col_4 = i_4 * 64;
            double sum_4 = 0;
            inner_4:for(k_4=0; k_4<64; k_4++) {
                k_col_4 = k_4 * 64;
                mult_4 = m1[i_col_4 + k_4] * m2[k_col_4 + j_4];
                sum_4 += mult_4;
            }
            prod[i_col_4 + j_4] = sum_4;
        }
    }
}
